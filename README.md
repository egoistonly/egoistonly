...
AI-инженер, CEO и CTO. Проектирую LLM-системы и агентов, довожу их до продакшена и собираю
команды, которые их поддерживают. Одинаково спокойно пишу инференс-пайплайн, фронтенд
и процесс найма.
